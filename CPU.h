...
private: //OPCODES
    ...
    /*  30+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  40+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  50+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  60+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  70+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  80+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  90+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  A0+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  B0+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  C0+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  D0+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  E0+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
    /*  F0+  */              OPCODE p_B();                  OPCODE p_C();                 OPCODE p_D();                 OPCODE p_E();              OPCODE p_H();                   OPCODE p_L();          OPCODE p_Addr_HL();             OPCODE p_A();          OPCODE p_B();                      OPCODE p_C();       OPCODE p_D();                     OPCODE p_E();             OPCODE p_H();                  OPCODE p_L();                OPCODE p_Addr_HL();        OPCODE p_A();
