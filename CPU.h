...
private: //OPCODES
    ...
    /*  10+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  20+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  30+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  40+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  50+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  60+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  70+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  80+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  90+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  A0+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  B0+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  C0+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  D0+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  E0+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
    /*  F0+  */              OPCODE p();                    OPCODE p();                   OPCODE p();                   OPCODE p();                OPCODE p();                     OPCODE p();            OPCODE p();                     OPCODE p();            OPCODE p();                        OPCODE p();         OPCODE p();                       OPCODE p();               OPCODE p();                    OPCODE p();                  OPCODE p();                OPCODE p();
